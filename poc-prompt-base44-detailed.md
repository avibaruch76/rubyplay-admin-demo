...
Each translatable record needs a `translations` field (JSON or related table) structured as:
```
{
  "es": {
...
Server-side flow (use Base44's serverless function or backend action):
